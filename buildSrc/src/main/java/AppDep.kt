object AppDep {
    ...
    const val okhHttp3Interceptor = "com.squareup.okhttp3:logging-interceptor:${DepVersion.okhttp3Version}"
    ...
    const val leakcanary = "com.squareup.leakcanary:leakcanary-android:${DepVersion.leakcanaryVersion}"
    ...
    const val playStoreCore = "com.google.android.play:core:${DepVersion.playCoreVersion}"
    const val playStoreKtx = "com.google.android.play:core-ktx:${DepVersion.playCoreKtxVersion}"

    const val facebookSdk = "com.facebook.android:facebook-android-sdk:${DepVersion.facebookVersion}"
    const val facebookMarketing = "com.facebook.android:facebook-marketing:${DepVersion.facebookMarketingVersion}"

    const val mapSdk = "com.google.android.gms:play-services-maps:${DepVersion.mapVersion}"
    const val mapLocation = "com.google.android.gms:play-services-location:${DepVersion.mapLocationVersion}"
